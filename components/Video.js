...
class Video extends Component {
  ...
  seek(currentTime) {
    ...
    console.log("seek called", currentTime);
  ...
  onSeek(e) {
    console.log("onSeek fn called", e);
  }
  ...
  renderPlayer() {
    ...
    return (
      ...
      >
        ...
        {/* Need to change in Video Player 
				onSeek={currentTime => {
              let { playableDuration, seekableDuration } = this.state.time;
              let obj = {
                playableDuration: playableDuration,
                seekableDuration: seekableDuration,
                currentTime: currentTime,
              };
              this.video.state.currentTime = currentTime;
              this.setState({ time: obj }, () => {
                console.log(
                  'time after seek',
                  this.state.time,
                  this.video.state.currentTime,
                );
              });
            }} */}
        <Controls
          ...
          loading={loading}
          onSeek={(val) => {
            console.log("inside video control", val);
            this.setState({ seeking: true, currentTime: val });
            this.player.seek(val, 100);
            this.props.onSeek(val);
